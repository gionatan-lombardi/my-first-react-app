...
export const trans = _client.trans;
export const getCache = _cache.getCache;
export const loadCache = _cache.loadCache;
export const getVueTranslationKeys = _vue.getVueTranslationKeys;